 ...
 * @date 2024-01-01
 */
public interface TPositionTrackMapper {
     ...
     * @return 结果
     */
    public int insertTPositionTrack(TPositionTrack tPositionTrack);
     ...
     * @return 结果
     */
    public int updateTPositionTrack(TPositionTrack tPositionTrack);
